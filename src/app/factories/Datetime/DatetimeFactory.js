(function () {
  ...
  function ArrayUtilFactory() {
    ...
    /**
        Función que mueve un item de un array al mismo array o a un segundo array
        @param {Array} arr Primer array del que se sacara el item
        @param {Integer} fromIndex Indice del item que se sacará del primer array
        @param {Integer} toIndex Indice del lugar en el que se pusheará en el segundo array si está definido
        @param {Array} arr2 Segundo array en el que se pusheará si está definido
    */
    ...
    /**
        Función que inserta un item a un array en una posicion
        @param {Array} arr Array en el que se pusheará el item
        @param {Integer} toIndex Indice del lugar en el que se pusheará el item
        @param {Generico} item Elemento que se pusheará al array
    */
    ...
    /**
        Función que busca un objeto en un array
        @param {Array} arr Array que tiene objetos
        @param {string} attr Atributo de un objeto del array
        @param {string} val Valor con el que se comparará
        @param {Boolean} sw_obj True la función devuelve el objeto encontrado, false|undefined la función devuelve true si encuentra el objeto
    */
  ...
  function DatetimeFactory(Util, ArrayUtil) {
    ...
    function date(pDate, separator) {
      ...
      // var date = pDate[i].split(separator || '-');
